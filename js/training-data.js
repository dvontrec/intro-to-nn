const trainingData = [
  ...
  {
    input:
      "On my way the the @createcultivate event! I’m being interviewed about business by my bff Allison. This should be fun!",
    output: { kardashian: 1 }
  },
  {
    input:
  ...
  {
    input:
      "Fashion Week is so much fun in the #KimKardashianGame! I'd love to see what you're wearing! http://smarturl.it/PlayKKH",
    output: { kardashian: 1 }
  },
  {
    input:
